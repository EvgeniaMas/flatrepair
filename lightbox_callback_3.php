...
<head>
<meta charset="utf-8">
<title>lightbox_callback_3</title>
<link href="Favicon.png" rel="shortcut icon">
<link href="styles/Eurostroy-remont.by.css" rel="stylesheet">
<link href="styles/lightbox_callback_3.css" rel="stylesheet">
<script>
      ...
      <div id="lightbox_callback_1Layer1">
         <div id="lightbox_callback_1Layer1_Container">
            <div id="wb_indexText132">
               <span id="wb_uid0"><strong>Задайте Ваш вопрос</strong></span></div>
            <hr id="indexLine13">
            <div id="wb_indexForm6">
               <noindex><form name="Form_lightbox_callback_2" method="post" action="lightbox_callback_3.php" enctype="multipart/form-data" accept-charset="UTF-8" id="indexForm6" onsubmit="return ValidateForm_lightbox_callback_2(this)">
                     <input type="hidden" name="formid" value="indexform6">
                     <div id="indexHtml1">
                        <button class="button_form_1" type="submit">Задать вопрос</button>
                        <input type="hidden" name="button" value="Задать вопрос"></div>
                     <div id="wb_indexText122">
                        <span id="wb_uid1">Введите Ваш вопрос:</span></div>
                     <textarea name="Question" id="indexTextArea1" rows="3" cols="32" maxlength="150" placeholder="&#1042;&#1072;&#1096; &#1074;&#1086;&#1087;&#1088;&#1086;&#1089;"></textarea>
